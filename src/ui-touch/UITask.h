...
public:
  ...
  enum : uint8_t {
    ...
    // RegionRegistry slot -- 0 = none/unknown, 15 = several regions matched, and
    // 1..14 name one. Packed into the spare top nibble on purpose: meta_flags is
    ...
    // for the life of the history -- never a list index -- so deleting or
